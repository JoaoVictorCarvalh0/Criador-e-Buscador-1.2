...
@profile
def main():
    nome_arq = "numerosBi.txt"
    num_procurado = random.randint(1, 1000000000)
    encontrou = False
    total_numeros = 0

    while not encontrou and total_numeros < 1000000000:
    ...
    if total_numeros >= 1000000000:
        print("1 bilhão de números, porem o número não foi encontrado.")
